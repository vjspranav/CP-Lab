...
int main()
{
	...
	do
	{
		...
		switch(i)
		{
			...
			case 4:len();
			break;
			case 5: cout<<"How many items do you want to enter?"; 
			cin>>k;
			for(m=0;m<k;m++)
			{
				insert2();
			...
			rev();
			break;
			case 6: cout<<"How many items do you want to enter?"; 
			cin>>l;
			for(m=0;m<l;m++)
			{
				insert3();
			...
			search();
			break;
			case 7: cout<<"How many items do you want to enter?"; 
			cin>>d;
			for(m=0;m<d;m++)
			{
				insert4();
			...
			copy();
			break;
			case 8: cout<<"How many items do you want to enter?"; 
			cin>>e;
			for(m=0;m<e;m++)
			{
				insert5();
